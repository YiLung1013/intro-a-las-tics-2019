			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Transporte</span> - Formulario</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_layout_horizontal.php" class="breadcrumb-item">Transporte</a>
					...
					<div class="card-body">
						<form action="#">
							<div class="row">
								<div class="col-md-6">
									<fieldset>
										<legend class="font-weight-semibold"><i class="icon-truck mr-2"></i> Boletos de transporte</legend>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<select data-placeholder="Selecciona el ruta" class="form-control form-control-select2" data-fouc>
													<option></option>
													
													<optgroup label="Rutas">
														<option value="R1">Ruta 1</option>
														<option value="R2">Ruta 2</option>
													</optgroup>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<select data-placeholder="Selecciona el horario" class="form-control form-control-select2" data-fouc>
													<option></option>
													
													<optgroup label="Matutino">
														<option value="M1">7:00</option>
														<option value="M2">8:00</option>
													</optgroup>
													<optgroup label="Vespertino">
														<option value="V1">1:00</option>
														<option value="V2">2:00</option>
													</optgroup>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Fechas para el transporte:</label>
											<div class="col-lg-9">
												<select data-placeholder="Selecciona las fechas" class="form-control form-control-select2" data-fouc>
													<option></option>
													
													<optgroup label="Meses">
														<option value="F1">1 Mes</option>
														<option value="F2">2 Meses</option>
														<option value="F3">3 Meses</option>
													</optgroup>
													
													<optgroup label="Cuatrisemestres">
														<option value="F101">1 Cuatrisemestre</option>
														<option value="F102">3 Cuatrisemestre</option>
													</optgroup>
