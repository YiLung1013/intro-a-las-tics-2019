				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="datatable_materia.php" class="nav-link active">Lista</a></li>
							</ul>
						</li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Materias</span> - Lista</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_basic.php" class="breadcrumb-item">Materias</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Lista de materia</h5>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							<tr>
								<td>10005</td>
								<td>Introduccion a la tecnologia de informacion</td>
								<td>1</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Matricula de materia</label>
										<div class="col-sm-9">
											<input type="text" placeholder="10001" class="form-control">
										</div>
									</div>
									
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Nombre de materia</label>
										<div class="col-sm-9">
											<input type="text" placeholder="Ingles" class="form-control">
										</div>
									</div>	
									
									<div class="form-group row">
										<label class="col-form-label col-sm-3">cuatrisemestre</label>
										<div class="col-sm-9">
				...
				<div id="modal_theme_warning" class="modal fade" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<h6 class="font-weight-semibold">Eliminar materia</h6>
								<p>Al hacer siguiente opcion la materia se eliminara completamente por siempre, estas seguro de seguir?</p>
							</div>
