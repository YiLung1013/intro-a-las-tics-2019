...
<head>
	...
	<script src="assets/js/demo_pages/datatables_api.js"></script>
	<!-- /theme JS files -->
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								...
								<li class="nav-item"><a href="datatable_api.php" class="nav-link active">Lista</a></li>
							</ul>
						</li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Maestros</span> - Lista</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_api.php" class="breadcrumb-item">Maestros</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Lista de maestro</h5>
					...
					<table class="table datatable-selection-single">
						...
						<tbody>
							<tr>
								...
								<td>Nixon</td>
				                <td>Maestro</td>
				                <td>1001@upv.edu.mx</td>
				                <td>8349579963</td>
				                <td><span class="badge badge-success">$320,800</span></td>
				            ...
				            <tr>
								...
								<td>Winters</td>
				                <td>Profesor</td>
				                <td>1002@upv.edu.mx</td>
				                <td>8346586667</td>
				                <td><span class="badge badge-success">$170,750</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
				            ...
				            <tr>
								...
								<td>Cox</td>
				                <td>Ingeniero</td>
				                <td>1003@upv.edu.mx</td>
				                <td>8342215478</td>
				                <td><span class="badge badge-success">$86,000</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
				            ...
				            <tr>
								...
								<td>Satou</td>
				                <td>Maestro</td>
				                <td>1005@upv.edu.mx</td>
				                <td>8340000123</td>
				                <td><span class="badge badge-success">$162,700</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
				            ...
				            <tr>
								...
								<td>Williamson</td>
				                <td>Profesor</td>
				                <td>1006@upv.edu.mx</td>
				                <td>8341111243</td>
				                <td><span class="badge badge-success">$372,000</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
				            ...
				            <tr>
								...
								<td>Chandler</td>
				                <td>Maestro</td>
				                <td>1007@upv.edu.mx</td>
				                <td>8346558375</td>
				                <td><span class="badge badge-success">$137,500</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
				            ...
				            <tr>
								...
								<td>Davidson</td>
				                <td>Maestro</td>
				                <td>1008@upv.edu.mx</td>
				                <td>8342154443</td>
				                <td><span class="badge badge-success">$97,900</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
				            ...
				            <tr>
								...
								<td>Frost</td>
				                <td>Maestro</td>
				                <td>1010@upv.edu.mx</td>
				                <td>8345741241</td>
				                <td><span class="badge badge-success">$103,600</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Maestro" class="form-control">
										</div>
									</div>
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Salario</label>
										<div class="col-sm-9">
											<input type="text" placeholder="$100,000" class="form-control">
										</div>
									</div>
								</div>
