				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="form_layout_vertical.php" class="nav-link active">Formulario</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Maestro</span> - Formulario</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_layout_horizontal.php" class="breadcrumb-item">Maestros</a>
					...
					<div class="card-body">
						<form action="#">
							<div class="row">
								<div class="col-md-6">
									<fieldset>
										<legend class="font-weight-semibold"><i class="icon-reading mr-2"></i> Detalles de usuario</legend>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Contrasenia:</label>
											<div class="col-lg-9">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Titulacion:</label>
											<div class="col-lg-9">
												<select data-placeholder="Selecciona tu titulacion" class="form-control form-control-select2" data-fouc>
													<option></option>
													<option value="IN">INGENIERO</option>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Zona de tiempo:</label>
											<div class="col-lg-9">
												<select data-placeholder="Selecciona tu zona de tiempo" class="form-control form-control-select2" data-fouc>
													<option></option>
								...
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" placeholder="123abc@gmail.com" class="form-control">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" placeholder="+834-123-4567" class="form-control">
											</div>
										</div>

										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Locacion:</label>
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
														<div class="mb-3">
								                            <select data-placeholder="Pais" class="form-control form-control-select2" data-fouc>
								                            	<option></option>
													...
													<div class="col-md-6">
														<input type="text" placeholder="Estado" class="form-control mb-3">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" placeholder="Direccion donde vives" class="form-control">
											</div>
										</div>
