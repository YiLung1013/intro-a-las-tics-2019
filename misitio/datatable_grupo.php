				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="datatable_grupo.php" class="nav-link active">Lista</a></li>
							</ul>
						</li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Grupos</span> - Lista</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_basic.php" class="breadcrumb-item">Grupos</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Lista de grupo</h5>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="" class="dropdown-item"><i class="icon-table2"></i> Agregar materias</a>
												<a href="" class="dropdown-item"><i class="icon-compose"></i> Modificar materias</a>
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="27091" class="form-control">
										</div>
									</div>

									<div class="form-group row">
										<label class="col-form-label col-sm-3">Nombre de grupo</label>
										<div class="col-sm-9">
											<input type="text" placeholder="ITM-101" class="form-control">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="ITM" class="form-control">
										</div>
									</div>
